...
.set	BootCodeSize		= 522		; set to 0, compile and set to value in [.cseg] Used, compile again
...
BootSign:	.db		"ESCBL1"											; iff you change it then change sign in AVRootloader.ini
